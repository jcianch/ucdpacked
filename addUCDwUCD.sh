...
[
  ...
  {
    "version": "6.2.0.2.723425",
    "componentName": "ucd-designer"
  },
  {
    "version": "6.2.0.2.723956",
...
/opt/ibm-ucd/udclient/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-designer" -version "6.2.0.2.723425" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-designer"
/opt/ibm-ucd/udclient/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-engine" -version "6.2.0.2.723956" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-engine"
/opt/ibm-ucd/udclient/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-server" -version "6.2.0.2.723274" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-server"
/opt/ibm-ucd/udclient/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-server.db" -version "6.2.0.2.723274" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-server.db"

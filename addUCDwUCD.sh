...
curl --verbose -u admin:${MY_UCD_PASSWORD}   --insecure -F "file=@$MEDIA_DIR/ucdwucd/MobileFirst.json;type=application/json;filename=MobileFirst.json" \
...
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "MySQL" -version "5.6" -base "$MEDIA_DIR/ucdwucd/artifacts/MySQL"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "openjdk" -version "7" -base "$MEDIA_DIR/ucdwucd/artifacts/openjdk"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "Oracle" -version "11gR2" -base "$MEDIA_DIR/ucdwucd/artifacts/Oracle"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "RLKS" -version "8.1.4" -base "$MEDIA_DIR/ucdwucd/artifacts/RLKS"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-designer" -version "6.2.0.1.716119" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-designer"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-engine" -version "6.2.0.1.715978" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-engine"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-server" -version "6.2.0.1.716068" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-server"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "ucd-server.db" -version "6.2.0.1.714965" -base "$MEDIA_DIR/ucdwucd/artifacts/ucd-server.db"
/opt/ibm-ucd/udclient -weburl http://${IPADDRESS}:${MY_UCD_HTTP_PORT} -authtoken $token addVersionFiles -component "utilities" -version "1.0" -base "$MEDIA_DIR/ucdwucd/artifacts/utilities"
